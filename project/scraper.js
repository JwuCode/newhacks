...
var oldDate = new Date();
  ...
  async function webScraper() {
    ...
    if (views < 20) {
        let res = await fetch('https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&explaintext&exintro&titles=' + articleName);
        ...
        summary += "..."
        wikilink = "https://en.wikipedia.org/wiki/" + articleName
        return [wikilink, articleName, summary, true]
